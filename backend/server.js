...
import chatSettingsRoutes from './routes/chatSettings.js';
...
app.use('/api/crm/v1/chat-settings', chatSettingsRoutes);
app.use('/crm/v1/chat-settings', chatSettingsRoutes);
